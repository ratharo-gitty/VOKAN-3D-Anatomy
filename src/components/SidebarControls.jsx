...
import { Camera, Eye, Flame, Layers, Box, Search, RotateCcw } from 'lucide-react';
    ...
    <div className="w-full lg:w-72 bg-slate-900/90 backdrop-blur-xl border border-slate-800 rounded-2xl p-4 flex flex-col gap-5 shadow-xl">
      ...
      <div>
        ...
        <div className="mt-2">
          <button
            ...
            className={`w-full px-3 py-2 rounded-xl text-xs font-semibold flex items-center justify-center gap-2 transition-all border ${
              showSkeleton
          ...
          >
            ...
            <span>{showSkeleton ? 'Hide Skeleton Rig' : 'Show Skeleton Rig'}</span>
          </button>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="relative">
          <input
            type="text"
            placeholder="Search chest, lats, quads..."
            value={searchQuery}
